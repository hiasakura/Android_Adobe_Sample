 ...
 * Food商品一覧クラス
 */
public class ItemFoodList extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle bundle) {
        ...
        TargetLocationRequest viewedMbox = Target.createRequest(Const.MBOX_CATE_FOOD_VIEWED, Const.MBOX_SUCCESS_TEXT, null);
